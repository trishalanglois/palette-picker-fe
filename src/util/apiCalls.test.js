...
describe('deletePalette', () => {
    ...
    let mockTitle ='foster'
    let mockResponse ='Palette 1 has been successfully deleted'
    ...
    it('should remove palette', () => {
      expect(deletePalette(paletteId, projectId)).resolves.toEqual(mockResponse);
    })
